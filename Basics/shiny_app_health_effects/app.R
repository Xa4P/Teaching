...
social activities (like visiting friends, relatives, etc.)?"),
               ...
               column(width = 4,
                      ...
                      radioButtons(inputId = "QALY_comp_answer",
                                   ...
                                   choices = list("Intervention A" = 1, 
                                                  "Intervention B" = 2, 
                                                  "They provide the same number of QALYs" = 3),
                                   selected = 0),
  ...
  tabPanel("Assignment 5 - Determining utility values", fluid = TRUE,
           fluidPage(
             column(width = 6,
                    h2("This assignment aims to teach you how to use the Dutch EQ-5D-5L tarriff (Versteegh et al. - 2016) to calculate utility values based on a health state description."),
                    ...
                    actionButton(inputId = "check_EQ5D_calc",
                                 label = "Click to check your answers!"),
