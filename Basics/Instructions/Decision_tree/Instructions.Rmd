...
# Aim
The aim of this practical assignment is to perform a health economic analysis using a decision tree. You are asked to evaluating the cost-effectiveness of a management strategie for patients with unruptured intracranial aneurysms versus watchful waiting.
...
\newpage
# Decision tree
This section provides an explaination of the decision tree used in this practical assignment. The decision tree compares two strategies: "Aneurism treatment" and "Watchful waiting". The "Detection" rectangle represents the decision node (i.e. the point where the different strategies are defined). Both main branches of the decision tree describe the possible trajectories for each of these strategies. The circles are the chance nodes. The first Figure provides a textual description of the trajectories, and the second provides a description of which probabilities belongs to each branch of the decision tree.  
