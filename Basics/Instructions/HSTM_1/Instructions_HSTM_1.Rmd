...
2. Open the `Assignment_HSTM1_start.R` file and follow the instructions of this document or in the R file (these are the same). Use the model structure on the enxt page to perform the assignment.       
