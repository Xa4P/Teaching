...
p_post_major_stroke	 # TO CALCULATE (1.a.): probability to transit to "Post-major stroke" after a NON-FATAL stroke occured
p_post_minor_stroke	 # TO CALCULATE (1.a.): probability to transit to "Post-minor stroke" after a NON-FATAL stroke occured

r_inc_mi  # TO CALCULATE (1.b.): yearly incidence rate MI
r_inc_stroke # TO CALCULATE (1.b.): yearly incidence rate stroke
r_mort # TO CALCULATE (1.b.): yearly rate of death
...
m_tp_comp["Well", "Post-minor_stroke"] 
m_tp_comp["Well", "Post-major_stroke"] 
m_tp_comp["Well", "Post-MI"] 
m_tp_comp["Well", "Death_stroke"] 
m_tp_comp["Well", "Death_MI"] 
m_tp_comp["Well", "Death_other"] 

m_tp_comp["Post-minor_stroke", "Post-minor_stroke"]  
m_tp_comp["Post-minor_stroke", "Death_other"]  

m_tp_comp["Post-major_stroke", "Post-major_stroke"] 
m_tp_comp["Post-major_stroke", "Death_other"] 

m_tp_comp["Post-MI", "Post-MI"] 
m_tp_comp["Post-MI", "Death_other"] 
