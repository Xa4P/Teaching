...
kable(df_thx[,c("Year", "Inc_cost_A", "Inc_QALY_A", 
                "Inc_cost_A_d", "Inc_QALY_A_d")],
      digits = 3) # show difference for intervention A
```
...
kable(rbind(v_res_undisc,
        v_res_disc, 
        v_res_disc10), 
      caption = "Totals using the different discount rates",
      digits = 3)

kable(m_res_total, 
      caption = "ICERs using the different discount rates",
      digits = 3) #  show results
